...
public:
	...
	TDelegate<void(class ARPawnBase* Pawn, class AActor* DamagedActor, bool bWasCritical, int32 DamageSourceMask)> K2Node_CreateDelegate_OutputDelegate; // 0x0080(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class ARPawnBase* Pawn, const struct FDamageCombatEvent& DamageEventData)> K2Node_CreateDelegate_OutputDelegate_1; // 0x0090(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class ARPawnBase* Pawn, class AActor* DamagedActor, bool bWasCritical, int32 DamageSourceMask)> K2Node_CreateDelegate_OutputDelegate_2; // 0x00F0(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class ARPawnBase* Pawn, const struct FDamageCombatEvent& DamageEventData)> K2Node_CreateDelegate_OutputDelegate_3; // 0x010C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_BloodPassive1_StatusEffect_C_ExecuteUbergraph_BP_BloodPassive1_StatusEffect;
...
DUMPER7_ASSERTS_BP_BloodPassive1_StatusEffect_C_OnInstigatorDealtDamage;
...
public:
	...
	int32                                         CallFunc_GetCurrentStackCount_ReturnValue;         // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_BP_BloodPassive1_StatusEffect_C_OnInstigatorPreDealtDamage;
...
DUMPER7_ASSERTS_BP_BloodPassive1_StatusEffect_C_RemovePawnDrainDamageBonus;
