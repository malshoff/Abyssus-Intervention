...
// Package: BP_CameraShake_TeslaRifle_Fire
...
// BlueprintGeneratedClass BP_CameraShake_TeslaRifle_Fire.BP_CameraShake_TeslaRifle_Fire_C
// 0x0000 (0x01F0 - 0x01F0)
class UBP_CameraShake_TeslaRifle_Fire_C final : public ULegacyCameraShake
{
public:
