...
// BlueprintGeneratedClass BP_Ocean_Behavior_PrimaryFire_MutatorScript.BP_Ocean_Behavior_PrimaryFire_MutatorScript_C
// 0x0008 (0x0148 - 0x0140)
class UBP_Ocean_Behavior_PrimaryFire_MutatorScript_C final : public UBP_Ocean_Behavior_MutatorScript_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_Ocean_Behavior_PrimaryFire_MutatorScript_C; // 0x0140(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_BP_Ocean_Behavior_PrimaryFire_MutatorScript(int32 EntryPoint);
