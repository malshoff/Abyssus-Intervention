...
struct BPCM_Heal_Generic_C_BlueprintModifyPostProcess final
{
public:
	...
	class UBPCM_Heal_Generic_C*                   CallFunc_FindCameraModifierByClass_ReturnValue;    // 0x0780(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_BPCM_Heal_Generic_C_BlueprintModifyPostProcess;
