...
// Package: BP_OceanGod_Tentacle_DmgAndSlow_Projectile
...
// BlueprintGeneratedClass BP_OceanGod_Tentacle_DmgAndSlow_Projectile.BP_OceanGod_Tentacle_DmgAndSlow_Projectile_C
// 0x0028 (0x0678 - 0x0650)
class ABP_OceanGod_Tentacle_DmgAndSlow_Projectile_C final : public ABP_OceanGod_Tentacle_ProjectileBase_C
{
public:
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_OceanGod_Tentacle_DmgAndSlow_Projectile_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_OceanGod_Tentacle_DmgAndSlow_Projectile_C")
	}
	static class ABP_OceanGod_Tentacle_DmgAndSlow_Projectile_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_OceanGod_Tentacle_DmgAndSlow_Projectile_C>();
	}
};
DUMPER7_ASSERTS_ABP_OceanGod_Tentacle_DmgAndSlow_Projectile_C;
