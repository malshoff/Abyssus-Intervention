...
struct BP_CombatBow_ReturnArrow_ModScript_C_ExecuteUbergraph_BP_CombatBow_ReturnArrow_ModScript final
{
public:
	...
	class UBP_ArrowProjectile_Return_Script_C*    K2Node_DynamicCast_AsBP_Arrow_Projectile_Return_Script; // 0x0020(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_BP_CombatBow_ReturnArrow_ModScript_C_ExecuteUbergraph_BP_CombatBow_ReturnArrow_ModScript;
