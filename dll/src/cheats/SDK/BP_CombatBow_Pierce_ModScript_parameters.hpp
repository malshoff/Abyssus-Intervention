...
struct BP_CombatBow_Pierce_ModScript_C_ExecuteUbergraph_BP_CombatBow_Pierce_ModScript final
{
public:
	...
	class URProjectileBaseScript*                 CallFunc_GetProjectileScript_ReturnValue;          // 0x0018(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UBP_ArrowProjectile_Pierce_Script_C*    K2Node_DynamicCast_AsBP_Arrow_Projectile_Pierce_Script; // 0x0028(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_BP_CombatBow_Pierce_ModScript_C_ExecuteUbergraph_BP_CombatBow_Pierce_ModScript;
