...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0A79C110;
	constexpr int32 AppendString      = 0x01344FE0;
	constexpr int32 GNames            = 0x0A67FA58;
	constexpr int32 GWorld            = 0x0A4B63A0;
	constexpr int32 ProcessEvent      = 0x015636A0;
