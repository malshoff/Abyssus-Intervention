...
struct BP_Medic_EnemyMutator_C_ExecuteUbergraph_BP_Medic_EnemyMutator final
{
public:
	...
	float                                         K2Node_CustomEvent_Radius;                         // 0x00C8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class ARNPCPawnBase*>                  K2Node_MakeArray_Array;                            // 0x00D8(0x0010)(ConstParm, ReferenceParm)
	TArray<class AActor*>                         CallFunc_GetAllAliveEnemyPawnsInRadius_ReturnValue; // 0x00E8(0x0010)(ReferenceParm)
	...
	class AREnemyPawnBase*                        K2Node_DynamicCast_AsREnemy_Pawn_Base;             // 0x0110(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_GetAllAliveEnemyPawnsInRadius_Radius_ImplicitCast; // 0x0128(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_PlayHealVFX_Radius_ImplicitCast;          // 0x0130(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_Medic_EnemyMutator_C_ExecuteUbergraph_BP_Medic_EnemyMutator;

// Function BP_Medic_EnemyMutator.BP_Medic_EnemyMutator_C.PlayHealVFX
// 0x0020 (0x0020 - 0x0000)
struct BP_Medic_EnemyMutator_C_PlayHealVFX final
{
public:
...
DUMPER7_ASSERTS_BP_Medic_EnemyMutator_C_PlayHealVFX;
