...
// Function BP_LevelExit.BP_LevelExit_C.ContinueFromInfiniteModePrompt
// (BlueprintCallable, BlueprintEvent)

void ABP_LevelExit_C::ContinueFromInfiniteModePrompt()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_LevelExit_C", "ContinueFromInfiniteModePrompt");
...
bool ABP_LevelExit_C::IsShareable(class APlayerController* PlayerController)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_LevelExit_C", "IsShareable");

	Params::BP_LevelExit_C_IsShareable Parms{};
...
void ABP_LevelExit_C::OnPromptAnswer_Event(bool ToVoid)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_LevelExit_C", "OnPromptAnswer_Event");

	Params::BP_LevelExit_C_OnPromptAnswer_Event Parms{};
...
void ABP_LevelExit_C::ShareInteractableActor(const class APlayerController* PlayerController)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_LevelExit_C", "ShareInteractableActor");

	Params::BP_LevelExit_C_ShareInteractableActor Parms{};
