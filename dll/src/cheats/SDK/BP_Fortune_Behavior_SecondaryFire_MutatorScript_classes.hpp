...
// BlueprintGeneratedClass BP_Fortune_Behavior_SecondaryFire_MutatorScript.BP_Fortune_Behavior_SecondaryFire_MutatorScript_C
// 0x0008 (0x01C0 - 0x01B8)
class UBP_Fortune_Behavior_SecondaryFire_MutatorScript_C final : public UBP_Fortune_Behavior_MutatorScript_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_Fortune_Behavior_SecondaryFire_MutatorScript_C; // 0x01B8(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_BP_Fortune_Behavior_SecondaryFire_MutatorScript(int32 EntryPoint);
