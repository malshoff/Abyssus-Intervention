...
// BlueprintGeneratedClass BP_WinOnDifficulty1_Challenge.BP_WinOnDifficulty1_Challenge_C
// 0x0008 (0x0038 - 0x0030)
class UBP_WinOnDifficulty1_Challenge_C final : public URChallengeScript
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame;                                    // 0x0030(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_BP_WinOnDifficulty1_Challenge(int32 EntryPoint);
