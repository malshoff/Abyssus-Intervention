...
struct BP_AncientSpear_ChainPulse_CharacterMutatorScript_C_ChainPulse final
{
public:
	...
	TArray<class ARAncientSpear*>                 ActiveSpears;                                      // 0x0008(0x0010)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
DUMPER7_ASSERTS_BP_AncientSpear_ChainPulse_CharacterMutatorScript_C_ChainPulse;
...
struct BP_AncientSpear_ChainPulse_CharacterMutatorScript_C_ExecuteUbergraph_BP_AncientSpear_ChainPulse_CharacterMutatorScript final
{
public:
	...
	class AActor*                                 K2Node_CustomEvent_TriggeringActor;                // 0x0048(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TArray<class ARAncientSpear*>                 K2Node_CustomEvent_ActiveSpears;                   // 0x0050(0x0010)(ConstParm, ReferenceParm)
	...
	class URGCharacterMutatorScript*              CallFunc_GetCharacterMutator_ReturnValue;          // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UBP_AncientSpear_CharacterMutatorScript_C* K2Node_DynamicCast_AsBP_Ancient_Spear_Character_Mutator_Script; // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_Array_IsEmpty_ReturnValue;                // 0x00EE(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_WaitDelay_Time_ImplicitCast;              // 0x0140(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_AncientSpear_ChainPulse_CharacterMutatorScript_C_ExecuteUbergraph_BP_AncientSpear_ChainPulse_CharacterMutatorScript;
