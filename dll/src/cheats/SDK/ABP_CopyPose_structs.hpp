...
struct ABP_CopyPose::FAnimBlueprintGeneratedConstantData final : public FAnimBlueprintConstantData
{
public:
	...
	struct FAnimNodeExposedValueHandler_PropertyAccess AnimGraphNode_PoseSnapshot;                   // 0x0128(0x0030)()
};
DUMPER7_ASSERTS_ABP_CopyPose__FAnimBlueprintGeneratedConstantData;
